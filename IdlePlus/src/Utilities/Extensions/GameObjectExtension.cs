...
namespace IdlePlus.Utilities.Extensions {
	public static class GameObjectExtension {
		...
		/// <summary>
		/// Check if this GameObject is active, ignoring parent GameObjects active
		/// state.
		///
		/// This might return true even when methods like GameObject#Update() aren't
		/// being called, as it only checks this GameObject, not its parents.
		/// </summary>
		...
		/// <summary>
		/// Check if this GameObject is active in any sense, meaning it is active
		/// and all its parents are also active.
		///
		/// This will return true when methods like GameObject#Update() are being
		/// called, as it checks the entire hierarchy.
		/// </summary>
